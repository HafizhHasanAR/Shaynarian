              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  ...
                  >
                    ...
                    >
                      <img src="img/product_nike/rush-2.jpg" alt="" />
                    </div>
                    ...
                    >
                      <img src="img/product_nike/rush-3.jpg" alt="" />
                    </div>
                    ...
                    >
                      <img src="img/product_nike/rush-4.jpg" alt="" />
                    </div>
                    ...
                    >
                      <img src="img/product_nike/rush-1.jpg" alt="" />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/product_nike/rush-1.jpg",
      thumbs: [
        "img/product_nike/rush-1.jpg",
        "img/product_nike/rush-2.jpg",
        "img/product_nike/rush-3.jpg",
        "img/product_nike/rush-4.jpg",
      ],
    };
  },
  methods: {
